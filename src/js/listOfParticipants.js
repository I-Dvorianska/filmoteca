...
<ul class="team-wrapper">
  <li class="team-card">
    ...
    <p class ='functions'>Library and Queue functionality</p>
  ...
  <li class="team-card">
    ...
    <p class ='functions'>Input search</p>
  ...
  <li class="team-card">
    ...
    <p class ='functions'>Pagination, header, footer</p>
  ...
  <li class="team-card">
    ...
    <p class="team-role">Developer</p>
    <p class ='functions'>Movie modal</p>
  ...
  <li class="team-card">
    ...
    <p class="team-role">Developer</p>
    <p class ='functions'>Movie list styles, markup</p>
  ...
  <li class="team-card">
    ...
    <p class="team-role">Developer</p>
    <p class ='functions'>Team modal, up button</p>
  ...
  <li class="team-card">
    ...
    <p class="team-role">Developer</p>
    <p class ='functions'>Local storage</p>
